...
import (
	...
	"github.com/googollee/go-socket.io/payload"
...
func (s *session) Emit(msg string, v ...interface{}) {
	panic("implement me")
}
...
func (s *session) NextReader() (base.FrameType, io.ReadCloser, error) {
	for {
...
func (s *session) NextWriter(typ base.FrameType) (io.WriteCloser, error) {
